...
<html lang="en" dir="ltr">
  ...
  <div class="card-body">
      <div class="table-responsive">
        <a class="btn btn-primary" href="AddUsr.php" role="button">Add registry</a>
          <br>
          <br>
          <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                      <?php
                    require('conn.php');
                    $query = "SELECT * From sys_Usuarios";
                    $validquery=sqlsrv_query($conn, $query);
                      ...
                      <tr>
                          ...
                          <td><h4><?php echo $Rol;?></h4></td>
                          <td><h4><?php echo $mail;?></h4></td>

                           <td>
                             <a class="btn btn-primary"
                   href="UpdateUsr.php?id=<?php echo $Id?>"
                   role="button">Modify</a>
                                  <br>
                              <br>
                          <a class="btn btn-danger"
                          href="DeleteUsr.php?id=<?php echo $Id?>"
