        ...
        <div class="row">
          <div class="row p-5">
            ...
            <div class="p-5 col-4 text-center">
              <a class="btn btn-primary justify-content-center" href="vistasS0.php" role="button">Reviews</a>
            </div>
            <div class="p-5 col-4 text-center">
              <a class="btn btn-primary justify-content-center" href="vistasS1.php" role="button">Tags</a>
            </div>
            <div class="p-5 col-4 text-center">
              <a class="btn btn-primary justify-content-center" href="vistasS2.php" role="button">Dolla dolla ching ching</a>
            </div>
          </div>
          <div class="row p-5">
