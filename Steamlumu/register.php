...
$query = "INSERT INTO sys_Usuarios (Nombre,Email,Password,IDGrupo) VALUES ('$nombre','$correo','$contrasena','2')";
      ...
      <div class="row d-flex justify-content-center p-5 col-12">
        <form class="user" action="register.php" method="POST">
          ...
          <div class="p-5 col-12 text-center" >
            <input type="submit" name="insert" value="Registrarse" class="btn btn-primary justify-content-center" role="button">
          </div>
          <div class="p-5 col-12 text-center">
