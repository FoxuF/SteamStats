...
$UserPassword = SHA1($_POST['Pass']);
    ...
    $consulta = "SELECT * FROM sys_Usuarios WHERE Email = '".$usuario."' ";
...
<html lang="en" dir="ltr">
  ...
  <body>
    <nav class="navbar navbar-light bg-dark">
      <a class="p-3 mb-2 navbar-brand text-white " href="index.php">Steam Stats</a>
      <a class="navbar-brand" href="login.php"> <img src="img/user_icon.png" width="30" height="30" alt=""> </a>
    </nav>
      ...
      <div class="row d-flex justify-content-center p-5 col-12">
        <form class="user" method="POST" action="login.php">
          ...
          <div class="p-5 col-12 text-center">
            <input type="submit" name="insert" value="Iniciar Sesion" class="btn btn-primary justify-content-center" role="button">
          </div>
        </form>
        <hr>
